...
const routerReducer = (history) => {
    ...
    return (state = initialState, arg: any = {}) => {
        (window as any).initialReduxState.router.location.pathname = state.location.pathname;
        (window as any).initialReduxState.router.location.search = state.location.search;
        (window as any).initialReduxState.router.location.hash = state.location.hash;
