        ...
        return <div className="navbar navbar-default">
            <div className="container-fluid">
                <div className="navbar-header">
                    ...
                    <a className="navbar-brand" href="/">CompliChain</a>
                </div>
                <div id="navbar" className="navbar-collapse collapse nav navbar-nav navbar-right">
                    <ul className="nav navbar-nav">
                        <li><NavLink exact to={'/'} activeClassName="active">Jobs</NavLink></li>
                        <li><NavLink exact to={'/info'} activeClassName="active">Admin</NavLink></li>
